...
There are things the plugin doesn't cover, such as community extensions, CSS snippets, graph view, and other GUI only features that are exclusive to the Obsidian app. Because of that, I still open the Obsidian app for a quick glance at the graph and if I want to read the CSS snippets I implemented.
